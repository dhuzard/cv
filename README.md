...
You can use the [editor on GitHub](https://github.com/dhuzard/cv/edit/gh-pages/index.md) to maintain and preview the content for your website in Markdown files.
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/dhuzard/cv/settings/pages). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
...
**2-week lab visiting** in the Lab of ... at RUB<br>
[SPICED Academy](https://www.spiced-academy.com/) - Bochum, Germany _(Apr 2017 - Jun 2017)_ <br>
